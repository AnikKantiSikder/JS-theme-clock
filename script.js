...
toggleEl.addEventListener("click", function(e) {
    ...
    // Without changing the text we can use --
    //html.classList.toggle('dark');

    // If we want to change the text also--
...
function setTime(){
    ...
    // Hours and minutes with adding 0 for single minutes like(12:05)
    timeEl.innerHTML =
...
// JS-JQUERY map a range of numbers to another range of numbers(algorithm)
